class Callable
  ...
  @@c = {
    ...
    :monocolor => lambda { |gen_r, gen_c, chs, block| monocolor(gen_r, gen_c, chs, &block) },
    :other => lambda { |gen_r, gen_c, chs, block| other(gen_r, gen_c, chs, &block) },
  }
  ...
  def monocolor(gen_r, gen_c, chs, &block)
  ...
  def other(gen_r, gen_c, chs, &block)
    przejscie_rc(gen_r, gen_c) do |r, c|
      block.call(r, c)
    end
  end

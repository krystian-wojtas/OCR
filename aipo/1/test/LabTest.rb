...
class LabTest
  ...
  def run(img_fn)
    ...
    FImg4R.new(img_fn).grayscale1.histogram.write('1/test/out/grayscale1_histogram.bmp')
    FImg4R.new(img_fn).grayscale2.histogram.write('1/test/out/grayscale2_histogram.bmp')
